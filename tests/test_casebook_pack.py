"""Regression checks for the apicurio casebook."""
...
from casebook.harness import assert_expected, apicurio_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apicurio_summary(), assert_expected())
