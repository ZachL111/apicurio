...
`apicurio` is centered on api tooling work in TypeScript. The technical target is: Diff OpenAPI fragments and classify breaking or additive changes.
...
The score is deterministic. The current threshold is 156. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 5.
